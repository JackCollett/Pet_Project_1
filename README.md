# ReactChat
A Image editing platform which allows users to log in, select and save their image by altering feature such as size and colour. 
<img width="1846" height="871" alt="ReactChat" src="https://github.com/user-attachments/assets/d5a911be-db35-43e1-8b83-8072aaee0543" />

Live Demo: <https://react-chat-na2h.onrender.com>


# How It's Made:

**Tech used:** HTML, CSS, JavaScript, Python(Flask) & PostgreSQL
...
# Commands to Install Locally (using Linux)
